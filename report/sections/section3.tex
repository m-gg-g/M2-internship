\section{Link with Percolation: two examples in $\Z^2$}
	...
	\subsection{Game 1} 
       ...
       \input{./sections/game1-player1-structure}
    ...
    \subsection{Game 2}     
        ...
        \input{./sections/game2-value-independence-from-the-initial-state-and-...}
       ...
       \begin{center}
        ...
        \input{./sections/game2-player1-structure}
        ...
        \begin{remark}\label{remark_structures_restricted_game2}
           ...
           \input{./sections/game2-player1-structure-remark}
        \end{remark}
